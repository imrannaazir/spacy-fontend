...
const ContactUs = () => {
    return (
        <div className="max-w-screen-md mx-auto p-5 mt-10">
            ...
            <form className="w-full">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div className="flex justify-between w-full px-3">
                        ...
                        <button className="shadow bg-primary hover:bg-indigo-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded" type="submit">
                            Send Message
                        </button>
                    </div>
