    ...
    return (
        <Zoom cascade>
            <div className="w-[95%] hover:scale-105 duration-500 my-8 mx-auto relative">
                <div className="grid gap-8 items-start justify-center w-[90%] lg:w-[75%] mx-auto">
                    <div className="relative group">
                        ...
                        <div className='bg-black text-white w-[100%]  mx-auto flex flex-col lg:flex-row gap-4  relative rounded-lg p-4'>
                            <div className={`lg:w-[30%] ${id % 2 === 0 ? 'lg:order-2' : 'lg:-order-2'} flex flex-col justify-between`}>
