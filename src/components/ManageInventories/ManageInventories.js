...
const ManageInventories = () => {
    ...
    return (
        <div>
            ...
            <Slide right>
                <div className='pl-[16%] py-4 flex items-end gap-6 bg-gradient-to-bl from-gray-500 rounded-l-3xl mb-4'>
                    <p className='text-3xl lg:text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-tr  from-white to-gray-500 '>MANAGE INVENTORIES -</p>
                </div>
            </Slide>
                        ...
                        <div className="relative group">
                            ...
                            <div
                                ...
                                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                                    <table className=" lg:w-[1200px] text-sm text-left text-gray-500 dark:text-gray-400">
