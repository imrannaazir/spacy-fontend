...
const MyItems = () => {
    ...
    return (
        <div>
            ...
            <Slide right>
                <div className='pl-[16%] py-4 flex items-end gap-6 bg-gradient-to-bl from-gray-500 rounded-l-3xl mb-10'>
                    <p className='text-3xl lg:text-5xl  text-transparent bg-clip-text bg-gradient-to-tr  from-white to-gray-500 '>MY ITEMS -</p>
                </div>
            </Slide>

            <Slide left>
                <div className="px-8 py-6 w-[100%]">
                    <div className="grid gap-8 items-start justify-end lg:justify-center w-[100%]">
                            ...
                            <div
                                ...
                                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                                    ...
                                    {rockets.length === 0 ?
                                        ...
                                        <table className="lg:w-[1200px] text-sm lg:text-left text-gray-500 dark:text-gray-400">
                                            <thead className="text-xs text-white uppercase bg-black">
                                                <tr>
                                                    <th scope="col" className="px-1 lg:px-6 py-3">
                                                        Name :
                                                    </th>
                                                    <th scope="col" className="px-1 lg:px-6 py-3">
                                                        Photo
